      ...
      <div className="focus-container">
        ...
        <div className="focus-controls">
          <button
            ...
            title="Exit (enabled when timer ends)"
            disabled={timeLeft > 0}
            onClick={() => {
              if (timeLeft <= 0 && onExit) onExit('timer', 'User exited after timer');
            }}
          >
            Exit
          </button>
          <button
            ...
            onClick={() => { if (onPaymentClick) onPaymentClick(); else showMotivationalMessage(); }}
          >
            Early Exit (Payment)
          </button>
        </div>
